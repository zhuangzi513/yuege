...
#define TABLE_FORMAT_FILTER_RESULT_DEF " (Date varchar(12), VolumeSale int, TurnOverSale double, PriceSale double, VolumeBuy int, TurnOverBuy double, PriceBuy double, FlowInOneDay double, SumFlowInTenDay double) "
#define TABLE_FORMAT_FILTER_RESULT " (Date, VolumeSale, TurnOverSale, PriceSale, VolumeBuy, TurnOverBuy, PriceBuy, FlowInOneDay, SumFlowInTenDay) "
...
#define S_STMT_FORMAT_FILTER_RESULT " VALUES (:Time, :VolumeSale, :TurnOverSale, :PriceSale, :VolumeBuy, :TurnOverBuy, :PriceBuy, :FlowInOneDay, :SumFlowInTenDay) "
